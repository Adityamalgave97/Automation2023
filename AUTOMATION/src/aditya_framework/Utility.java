...
public class Utility {
	...
	public static String getTestData(int rowIndex, int cellIndex) throws EncryptedDocumentException, IOException {
		FileInputStream file = new FileInputStream("D:\\java\\githubpass\\GitHubIDPWD.xlsx");
	...
	public static void captureScreenshot(WebDriver driver, int TCID) throws IOException {
		...
		File dest = new File("D:\\java\\screenshot" + TCID + ".png");
	...
	public static String getPropertyFileData(String key) throws IOException {
		...
		FileInputStream file = new FileInputStream(System.getProperty("user.dir") + "\\GitHub.propertie");
		obj.load(file);
